...
import walson.tcl.coolweather.db.CoolWeatherDB;
import walson.tcl.coolweather.model.City;
import walson.tcl.coolweather.model.Country;
import walson.tcl.coolweather.model.Province;
...
public class ChooseAreaActivity extends Activity {
    ...
    public static final int LEVEL_PROVICNE = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                if (currentLevel == LEVEL_PROVICNE) {
                    ...
                    String countryCode = countyList.get(i).getCountryCode();
